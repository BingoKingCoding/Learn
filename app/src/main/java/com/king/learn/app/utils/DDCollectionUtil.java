...
import com.king.learn.app.listener.DDSimpleIterateCallback;
...
/**
 * <集合工具类>
 * Created by wwb on 2017/9/18 17:47.
 */
...
public class DDCollectionUtil
{
    ...
    public static <T> boolean iterate(Iterable<T> iterable, DDIterateCallback<T> callback)
    {
    ...
    public static <T> boolean foreach(List<T> list, DDIterateCallback<T> callback)
    {
    ...
    public static <T> boolean foreachReverse(List<T> list, DDIterateCallback<T> callback)
    {
        if (!isEmpty(list) && callback != null)
        {
            int size = list.size();
    ...
    public static <T> boolean foreach(int count, DDSimpleIterateCallback callback)
    {
    ...
    public static <T> boolean foreachReverse(int count, DDSimpleIterateCallback callback)
    {
        if (count > 0 && callback != null)
        {
