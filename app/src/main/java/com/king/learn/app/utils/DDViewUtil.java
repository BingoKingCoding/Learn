...
import com.king.learn.app.DDLibrary;
...
public class DDViewUtil
{
    ...
    {
        return LayoutInflater.from(DDLibrary.getInstance().getContext());
    }
    ...
    {
        return DDLibrary.getInstance().getContext().getResources().getDisplayMetrics();
    }
